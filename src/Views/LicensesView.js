      ...
      {showNewDialog ? (
        <div className="mb-5 mt-3 border border-gray-300 p-3">
          ...
          <button
            ...
            type="button"
            className="inline-flex mb-3  mr-3 mt-3 pr-2 items-center px-2 py-1 border border-transparent shadow-sm text-base font-sm rounded-md text-white bg-blue-500 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
